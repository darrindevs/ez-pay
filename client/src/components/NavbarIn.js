...
// check authentication and do stuff
      ...
      {({ open }) => (
        <>
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16">
              <div className="flex">
                ...
                >
                <h1 className="text-indigo-800"><strong><Brand /></strong></h1>
                </Link>    
                </div>
                ...
                <Link
                to="/payment-profile"
                className={location.pathname === "/payment-profile" ? "nav-link active" : "nav-link"}
                >
                Payment Profile
                </Link>
                </span>
          ...
          <Disclosure.Panel className="sm:hidden">
            ...
            <span className="bg-indigo-50 border-indigo-500 text-indigo-700 block pl-3 pr-4 py-2 border-l-4 text-base font-medium nav-link">
                <Link
                to="/dashboard"
